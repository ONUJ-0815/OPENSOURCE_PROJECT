                        ...
                        if event.type == pygame.KEYUP and event.key == pygame.K_SPACE:
                            if user.position != 10 and user.position !=30:
                                if dice.roll_dice(user) == True:
                                    ...
                                    log_instance.add_message(" ")
                                    log_instance.add_message("1 ~ 5 = 아이템 사용")
                                    log_instance.add_message("|3번 -> 호텔|")
                                    log_instance.add_message("|2번 -> 빌라|")
                                    log_instance.add_message("|1번 --> 땅 |")
                                    log_instance.add_message("B = 땅 & 건물 사기")
                                    log_instance.add_message("T = 턴 넘기기")
